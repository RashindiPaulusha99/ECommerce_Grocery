                            ...
                            <Grid item xs={12} md={8} lg={8}>
                                <Grid container spacing={2}>
                                    ...
                                    <Grid item xs={12} md={6} lg={6}>
                                        ...
                                        <input type="text" className="form-control" id="name" placeholder="ice cream" onChange={(e)=>{
                                            setName(e.target.value)
                                        }}/>
                                    </Grid>
                                    <Grid item xs={12} md={6} lg={6}>
                                        <label htmlFor="qty" className="form-label mt-3">Qty On Hand</label>
                                        <input type="text" className="form-control" id="qty" placeholder="1000" onChange={(e)=>{
                                            setQty(e.target.value)
                                        }}/>
                                    </Grid>
                                    <Grid item xs={12} md={12} lg={12}>
                                        <label htmlFor="desc" className="form-label mt-3">Description</label>
                                        <textarea className="form-control" id="desc" rows="3" placeholder="lorem ipsum..." onChange={(e)=>{
                            ...
                            <Grid item xs={12} md={12} lg={12}>
                                <Grid container spacing={1}>
                                    <Grid item xs={12} md={3} lg={3}>
                                        ...
                                        <input type="text" className="form-control" id="discount" placeholder="5" onChange={(e)=>{
                                            setDiscount(e.target.value)
                                        }}/>
                                    </Grid>
                                    <Grid item xs={12} md={3} lg={3}>
                                        <label htmlFor="price" className="form-label mt-3">Unit Price(Rs.)</label>
                                        <input type="text" className="form-control" id="price" placeholder="100" onChange={(e)=>{
                                            setPrice(e.target.value)
                                        }}/>
                                    </Grid>
                                    <Grid item xs={12} md={3} lg={3}>
                                        <label htmlFor="volume" className="form-label mt-3">Volume</label>
                                        <input type="text" className="form-control" id="volume" placeholder="200" onChange={(e)=>{
                                            setVolume(e.target.value)
                                        }}/>
                                    </Grid>
                                    <Grid item xs={12} md={3} lg={3}>
                                        <label htmlFor="unitVolume" className="form-label mt-3">Unit Of Volume</label>
                                        <input type="text" className="form-control" id="unitVolume" placeholder="ml" onChange={(e)=>{
